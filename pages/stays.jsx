...
const Stays = () => {
	return (
		<div>
			...
			<p className="p-4 m-4">
				Delightful, family friendly caravan, our is a lovely 2 bedroom, 6 berth, dog friendly holiday caravan on the Littlesea Haven Holiday Park. This Caravan is our families van, which we hire out to families.
			</p>
			<Photos
